...
public class DeserializeArrayOfWithFourInts : ArrayBenchmarkBase<WithFourInts>
{
    protected override WithFourInts CreateElement(Random random) => new()
    {
        Int1 = random.Next(),
        Int2 = random.Next(),
        Int3 = random.Next(),
...
public sealed class WithFourInts
{
