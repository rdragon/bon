...
{
    [Fact] public void NullLongToString() => DeserializeSlow((long?)null, "");
    ...
    [Fact] public void NullDoubleToString() => DeserializeSlow((double?)null, "");
    ...
    [Fact] public void NullDecimalToString() => DeserializeSlow((decimal?)null, "");
